...
rom pyspark.sql.functions import col, explode, from_json, variant_get, lower, regexp_replace, regexp_extract, abs, when, max, coalesce
...
(invoice_gold.write.mode("overwrite")
 .saveAsTable("gold.invoice_data"))

# Display the final structured data [5]
display(spark.table("gold.invoice_data"))
